        ...
        <>
            ...
            <div className="profile-history w-full grid grid-cols-2 gap-4 mt-8 text-[#A900FD]">
                <div className="history-item">
                    <div class="mb-1 text-lg font-medium text-[#A900FD]">Total Score: </div>
                    <div class="w-full bg-gray-200 rounded-full h-4.5 mb-4">
                        <div class="bg-[#A900FD] text-sm font-medium text-white text-center p-1 leading-none rounded-full" style={{
                ...
                <div className="history-item">
                    <div class="mb-1 text-lg font-medium text-[#A900FD]">Average Score: </div>
                    <div class="w-full bg-gray-200 rounded-full h-4.5 mb-4">
                        <div class="bg-[#A900FD] text-sm font-medium text-white text-center p-1 leading-none rounded-full" style={{
                            width: `${userData?.totalScore ? (userData?.totalScore / (((Object.keys(userData?.gamePlayed)).length)) / globalVariable?.maxScore) * 100 : 100
                                }%`
                ...
                <div className="history-item">
                    <div class="mb-1 text-lg font-medium text-[#A900FD]">Best Score: </div>
                    <div class="w-full bg-gray-200 rounded-full h-4.5 mb-4">
                        <div class="bg-[#A900FD] text-sm font-medium text-white text-center p-1 leading-none rounded-full" style={{
                ...
                <div className="history-item">
                    <div class="mb-1 text-lg font-medium text-[#A900FD]">Match Won: </div>
                    <div class="w-full bg-gray-200 rounded-full h-4.5 mb-4">
                        <div class="bg-[#A900FD] text-sm font-medium text-white text-center p-1 leading-none rounded-full" style={{
                ...
                <div className="history-item">
                    <div class="mb-1 text-lg font-medium text-[#A900FD]">Average Time: </div>
                    <div class="w-full bg-gray-200 rounded-full h-4.5 mb-4">
                        <div class="bg-[#A900FD] text-sm font-medium text-white text-center p-1 leading-none rounded-full" style={{
                ...
                <div className="history-item">
                    <div class="mb-1 text-lg font-medium text-[#A900FD]">Best Time: </div>
                    <div class="w-full bg-gray-200 rounded-full h-4.5 mb-4">
                        <div class="bg-[#A900FD] text-sm font-medium text-white text-center p-1 leading-none rounded-full" style={{
